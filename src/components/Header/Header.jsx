...
const Header = () => {
  ...
  return(
    <>
      <header className="fixed top-0 min-w-screen p-3 z-[1100] bg-zinc-900">
        <div className="md:flex md:items-center md:justify-between relative">
          ...
          <nav className={`md:flex md:items-center text-center bg-zinc-900 md:static w-full absolute transition-all duration-300 ease-in-out ${isOpen ? 'left-[0px]' : 'left-[-900px]'}`}>
